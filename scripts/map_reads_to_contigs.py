...
parser.add_argument("-m", "--merged", help='merged or paired-end files[y/n], default = n]', default = 'n')
...
if not (args.fastafile and args.outputfile and args.readsdir): sys.exit(1)
if args.merged not in ['y','n']:sys.exit(1)
